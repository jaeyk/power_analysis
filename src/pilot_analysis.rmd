...
mods_cv <- list(
  ...
  "Model 3" = standardize(lm(china_virus_racist ~ violence_asian_cat + racial_covid_dis_cat + democracy_importance + pol_strong_leader + pol_democratic + pol_army_rule + china_fav + china_threat + china_demo + american_id_importance + national_attachment, df)),
  "Model 4" = standardize(lm(china_virus_racist ~ violence_asian_cat + racial_covid_dis_cat + democracy_importance + pol_strong_leader + pol_democratic + pol_army_rule + china_fav + china_threat + china_demo + dem + gop + american_id_importance + national_attachment, df))
)
```
