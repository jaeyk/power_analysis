...
df_numeric$democracy_sub <- idx_mean(df_numeric$democracy_meaning_2 + df_numeric$democracy_meaning_2 + df_numeric$democracy_meaning_3)
...
dem_pec_plot <- results %>%
  ...
  scale_y_continuous("Estimated CATE") +
  labs(col = "Subgroup",
       title = "Marginal effects across democracy perception") +
  coord_flip()+
  scale_fill_grey(start = 0.3, end = 0.7)
